Friend NotInheritable Class CredentialsSource
    Public Shared usuario As New YiZi.AccesoDatos.Usuarios
    Private Sub New()
    End Sub
    ...
    Shared Sub New()
        Using db As YiZi.AccesoDatos.Modelo = New YiZi.AccesoDatos.Modelo()
            Dim usuarios As List(Of YiZi.AccesoDatos.Usuarios) = db.Usuarios.ToList()
            credentials = New System.Collections.Hashtable()
            For Each usuario As YiZi.AccesoDatos.Usuarios In usuarios
    ...
    Friend Shared Function GetUsuario(ByVal login As String) As YiZi.AccesoDatos.Usuarios
        Using db As YiZi.AccesoDatos.Modelo = New YiZi.AccesoDatos.Modelo()
    ...
    Friend Shared Function CheckPermissions(ByVal modulo As String, ByVal operacion As String) As Boolean
        ...
        Using db As YiZi.AccesoDatos.Modelo = New YiZi.AccesoDatos.Modelo()
            ...
            Else
                ...
                Dim modulos As YiZi.AccesoDatos.Modulos = db.Modulos.Where(Function(x) x.Nombre = modulo).FirstOrDefault
                If Not modulos Is Nothing Then
                    Dim rolmodulooperacion As YiZi.AccesoDatos.Roles_Modulos_Operaciones = db.Roles_Modulos_Operaciones.Where(Function(x) x.IdRol = usuario.IdRol _
