...
Public Class SindicatoViewModel
    ...
    Protected Overrides Sub OnBeforeEntitySaved(ByVal key As Integer, ByVal entity As YiZi.AccesoDatos.Sindicatos, ByVal isNewEntity As Boolean)
    ...
    'Protected Overrides Sub OnEntitySaved(ByVal key As Integer, ByVal entity As YiZi.AccesoDatos.Sindicatos, ByVal isNewEntity As Boolean)
    ...
    '            Messenger.Default.Send(Of AmountMessage)(New AmountChangedMessage(entity, YiZi.AccesoDatos.Provincias, prevAmount))
    '        Else
