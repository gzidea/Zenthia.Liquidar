...
Partial Public Class wizardFormImportarNovedadesViewModel
    ...
    Public Overridable ReadOnly Property ListaEmpresas As List(Of YiZi.AccesoDatos.Empresas)
        Get
            Dim _empresas As List(Of YiZi.AccesoDatos.Empresas)
    ...
    Public Overridable ReadOnly Property ListaConvenios As List(Of YiZi.AccesoDatos.Convenios)
        Get
            Dim _convenios As List(Of YiZi.AccesoDatos.Convenios)
            Using db As YiZi.AccesoDatos.Modelo = New YiZi.AccesoDatos.Modelo()
    ...
    Public Overridable ReadOnly Property ListaTipoLiquidacion As List(Of YiZi.AccesoDatos.TipoLiquidacion)
        Get
            Dim _tipoliquidacion As List(Of YiZi.AccesoDatos.TipoLiquidacion)
            Using db As YiZi.AccesoDatos.Modelo = New YiZi.AccesoDatos.Modelo()
    ...
    Public Overridable Property SelectedEmpresa As YiZi.AccesoDatos.Empresas
    ...
    Private Property listaConveniosConNovedad As List(Of YiZi.AccesoDatos.Formulas)

    Public Overridable Property SelectedConvenio As YiZi.AccesoDatos.Convenios
    Public Sub OnSelectedConvenioChanged()
        ...
        Using db As YiZi.AccesoDatos.Modelo = New YiZi.AccesoDatos.Modelo()
            ...
            For Each item As YiZi.AccesoDatos.Formulas In listaConveniosConNovedad
    ...
    Public Overridable Property SelectedLiquidacion As YiZi.AccesoDatos.TipoLiquidacion
                ...
                Try
                    ...
                    Using db As YiZi.AccesoDatos.Modelo = New YiZi.AccesoDatos.Modelo()
                        For i As Integer = RowInicio To RowFin
                            Dim legajoNovedad As New YiZi.AccesoDatos.LegajosNovedades
                            Dim legajo As String = worksheet.Range(ColumnaLegajo & Str(i)).Value
                            Dim tmpLegajo As YiZi.AccesoDatos.Legajos = db.Legajos.Where(Function(x) x.Legajo = legajo And x.IdConvenio = SelectedConvenio.Id And x.IdEmpresa = SelectedEmpresa.Id).FirstOrDefault
