...
Public Class FiltrosLegajosNovedadesViewModel(Of TEntity As Class, TPrimaryKey, TUnitOfWork As IUnitOfWork)
    ...
    Public Overridable Property SelectTipoLiquidacion As YiZi.AccesoDatos.TipoLiquidacion
    ...
    Public Overridable Property SelectLegajo As YiZi.AccesoDatos.Legajos
    ...
    Public Overridable Property SelectedItemsLegajos As IEnumerable(Of YiZi.AccesoDatos.Legajos)
