...
Public Class LSDRegistro01ViewModel
    Inherits SingleObjectViewModel(Of YiZi.AccesoDatos.LSDRegistro01, Integer, IModeloDbContextUnitOfWork)

    Dim changedCustomPropertiesReg04 As List(Of YiZi.AccesoDatos.LSDRegistro04) = New List(Of YiZi.AccesoDatos.LSDRegistro04)()
    Dim changedCustomPropertiesReg03 As List(Of YiZi.AccesoDatos.LSDRegistro03) = New List(Of YiZi.AccesoDatos.LSDRegistro03)()
    Dim changedCustomPropertiesReg02 As List(Of YiZi.AccesoDatos.LSDRegistro02) = New List(Of YiZi.AccesoDatos.LSDRegistro02)()
    ...
    Public ReadOnly Property LookUpIdentificacionEnvio As IEntitiesViewModel(Of YiZi.AccesoDatos.IdentificacionEnvio)
        Get
    ...
    Public ReadOnly Property LookUpTipoLiquidacion As IEntitiesViewModel(Of YiZi.AccesoDatos.TipoLiquidacion)
        Get
    ...
    Public ReadOnly Property LSDRegistro02Details() As CollectionViewModel(Of YiZi.AccesoDatos.LSDRegistro02, Integer, YiZi.AccesoDatos.IModeloDbContextUnitOfWork)
        Get
    ...
    Public ReadOnly Property LSDRegistro03Details() As CollectionViewModel(Of YiZi.AccesoDatos.LSDRegistro03, Integer, YiZi.AccesoDatos.IModeloDbContextUnitOfWork)
        Get
    ...
    Public ReadOnly Property LSDRegistro04Details() As CollectionViewModel(Of YiZi.AccesoDatos.LSDRegistro04, Integer, YiZi.AccesoDatos.IModeloDbContextUnitOfWork)
        Get
    ...
    Public ReadOnly Property LookUpActivdadEmpleados As IEntitiesViewModel(Of YiZi.AccesoDatos.CodigosDeActivdadEmpleados)
        Get
    ...
    Public ReadOnly Property LookUpCondiciones As IEntitiesViewModel(Of YiZi.AccesoDatos.CodigosDeCondiciones)
        Get
    ...
    Public Sub GenerateReciboAndSave()
        ...
        Using db As YiZi.AccesoDatos.Modelo = New YiZi.AccesoDatos.Modelo()
            ...
            If db.LSDRegistro02.Where(Function(x) x.IdLSDRegistro01 = Me.Entity.Id).Count > 0 Then
                ...
                End If
            End If
            For Each item As YiZi.AccesoDatos.LSDRegistro02 In db.LSDRegistro02.Where(Function(x) x.IdLSDRegistro01 = Me.Entity.Id)
                db.LSDRegistro02.Remove(item)
                'db.SaveChanges()
            Next

            For Each item As YiZi.AccesoDatos.LSDRegistro03 In db.LSDRegistro03.Where(Function(x) x.IdLSDRegistro01 = Me.Entity.Id)
                db.LSDRegistro03.Remove(item)
                'db.SaveChanges()
            Next

            For Each item As YiZi.AccesoDatos.LSDRegistro04 In db.LSDRegistro04.Where(Function(x) x.IdLSDRegistro01 = Me.Entity.Id)
                db.LSDRegistro04.Remove(item)
                'db.SaveChanges()
            Next

            Dim reg01 As YiZi.AccesoDatos.LSDRegistro01 = db.LSDRegistro01.Where(Function(x) x.Id = Me.Entity.Id).FirstOrDefault()

            Dim recibos As IEnumerable(Of YiZi.AccesoDatos.Recibos) = db.Recibos.Where(Function(x) x.IdTipoLiquidacion = Me.Entity.IdTipoLiquidacion And x.Periodo = Me.Entity.Periodo And x.IdEmpresa = Me.Entity.IdEmpresa)
            Dim reg02 As YiZi.AccesoDatos.LSDRegistro02
            For Each recibo As YiZi.AccesoDatos.Recibos In recibos.ToList()
                Dim legajo As YiZi.AccesoDatos.Legajos = db.Legajos.Where(Function(x) x.Id = recibo.IdLegajo).FirstOrDefault()
                reg02 = New YiZi.AccesoDatos.LSDRegistro02
                ...
                If recibo.Total <> 0 Then
                    For Each recibodetalle As YiZi.AccesoDatos.RecibosDetalles In recibodetalles.ToList()
                        ...
                        Else
                            Dim reg03 As New YiZi.AccesoDatos.LSDRegistro03
                ...
                Else
                    ...
                    reg01.LSDRegistro03.Add(reg03)
                End If
                Dim reg04 As New YiZi.AccesoDatos.LSDRegistro04
    ...
    Public Overrides Sub Save()
        For Each item As YiZi.AccesoDatos.LSDRegistro02 In changedCustomPropertiesReg02
            LSDRegistro02Details.Save(item)
        Next
        For Each item As YiZi.AccesoDatos.LSDRegistro03 In changedCustomPropertiesReg03
            LSDRegistro03Details.Save(item)
        Next
        For Each item As YiZi.AccesoDatos.LSDRegistro04 In changedCustomPropertiesReg04
