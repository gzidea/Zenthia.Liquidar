...
Partial Class frmPrincipal
    ...
    Private Sub InitializeComponent()
        ...
        '
        Me.AccordionControlElement12.Elements.AddRange(New DevExpress.XtraBars.Navigation.AccordionControlElement() {Me.aceiEmpresas, Me.aceiObrasSociales, Me.aceiSindicatos})
        ...
        Me.mvvmContext.ViewModelType = GetType(YiZi.LiquidAR.Win.PrincipalViewModel)
        '
        'mvvmContextSelectorEmpresa
        '
        Me.mvvmContextSelectorEmpresa.ContainerControl = Me
        Me.mvvmContextSelectorEmpresa.ViewModelType = GetType(YiZi.LiquidAR.Win.EmpresaCollectionViewModel)
        '
        'frmPrincipal
        '
