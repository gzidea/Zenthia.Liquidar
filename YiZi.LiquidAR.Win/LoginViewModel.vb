...
Public Class LoginViewModel
    ...
    Public Overridable Property CurrentUser() As YiZi.AccesoDatos.Usuarios

    'Public Overridable Sub OnCurrentUserChanged()
    '    Dim usuario As YiZi.AccesoDatos.Usuarios = CredentialsSource.GetUsuario(CurrentUser.Login)
    'End Sub
    ...
    Public Sub Init()
        Me.CurrentUser = New YiZi.AccesoDatos.Usuarios()
    End Sub
