...
Public Class LegajoNovedadEditForm
    ...
    Private Sub InitBindings()
        ...
        fluent.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.LegajoNovedadDetails.SelectedEntity, Function(args) TryCast(args.Row, YiZi.AccesoDatos.LegajosNovedadesDetalles), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
