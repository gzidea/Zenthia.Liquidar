...
Public Class LegajosNovedades
    ...
    Private Sub InitBindings()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, YiZi.AccesoDatos.LegajosNovedades), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
    ...
    Private Function SetSelection(ByVal gv As ColumnView, ByVal selItems As IEnumerable(Of YiZi.AccesoDatos.LegajosNovedades)) As Boolean
        gv.BeginSelection()
        gv.ClearSelection()
        For Each it In (If(selItems, Enumerable.Empty(Of YiZi.AccesoDatos.LegajosNovedades)()))
    ...
    Private Function GetSelection() As IEnumerable(Of YiZi.AccesoDatos.LegajosNovedades)
        Return gridView.GetSelectedRows().[Select](Function(h) TryCast(gridView.GetRow(h), YiZi.AccesoDatos.LegajosNovedades)).ToArray()
    End Function
