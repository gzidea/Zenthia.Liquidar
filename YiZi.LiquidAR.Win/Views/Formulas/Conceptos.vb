...
Public Class Conceptos
    ...
    Private Sub InitBindings()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, YiZi.AccesoDatos.Conceptos), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
