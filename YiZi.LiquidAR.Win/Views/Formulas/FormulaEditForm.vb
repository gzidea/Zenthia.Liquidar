...
Public Class FormulaEditForm
    ...
    Private Sub InitBindings()
        ...
        fluent.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridViewPeriodos, "FocusedRowObjectChanged").SetBinding(Function(x) x.FormulaPeriodos.SelectedEntity, Function(args) TryCast(args.Row, YiZi.AccesoDatos.FormulasPeriodos), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
