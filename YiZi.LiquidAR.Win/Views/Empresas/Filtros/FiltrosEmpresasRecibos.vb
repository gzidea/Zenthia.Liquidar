...
Public Class FiltrosEmpresasRecibos
    ...
    Private Sub InitBindings()
        mvvmContext.ViewModelType = GetType(YiZi.LiquidAR.Win.RecibosFilterViewModel(Of YiZi.AccesoDatos.Recibos, Integer, YiZi.AccesoDatos.IModeloDbContextUnitOfWork))
        Dim fluent = mvvmContext.OfType(Of RecibosFilterViewModel(Of YiZi.AccesoDatos.Recibos, Integer, IModeloDbContextUnitOfWork))()
