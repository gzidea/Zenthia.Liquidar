...
Public Class ConvenioEditForm
    ...
    Private Sub InitBindings()
        ...
        fluent.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(CategoriasGridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.CategoriasDetails.SelectedEntity, Function(args) TryCast(args.Row, YiZi.AccesoDatos.Categorias), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
