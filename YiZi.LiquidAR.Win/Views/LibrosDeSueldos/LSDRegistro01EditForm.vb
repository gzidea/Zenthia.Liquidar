...
Public Class LSDRegistro01EditForm
    ...
    Private Sub InitBindings()
        ...
        fluent.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridViewReg04, "FocusedRowObjectChanged").SetBinding(Function(x) x.LSDRegistro04Details.SelectedEntity, Function(args) TryCast(args.Row, YiZi.AccesoDatos.LSDRegistro04), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
        ...
        fluent.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridViewReg03, "FocusedRowObjectChanged").SetBinding(Function(x) x.LSDRegistro03Details.SelectedEntity, Function(args) TryCast(args.Row, YiZi.AccesoDatos.LSDRegistro03), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
        ...
        fluent.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridViewReg02, "FocusedRowObjectChanged").SetBinding(Function(x) x.LSDRegistro02Details.SelectedEntity, Function(args) TryCast(args.Row, YiZi.AccesoDatos.LSDRegistro02), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
