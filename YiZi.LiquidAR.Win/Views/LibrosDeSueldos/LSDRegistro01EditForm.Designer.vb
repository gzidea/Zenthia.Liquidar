...
Partial Class LSDRegistro01EditForm
    ...
    Private Sub InitializeComponent()
        ...
        'RibbonPage1
        '
        Me.RibbonPage1.Groups.AddRange(New DevExpress.XtraBars.Ribbon.RibbonPageGroup() {Me.RibbonPageGroup1, Me.RibbonPageGroup2, Me.RibbonPageGroup3, Me.RibbonPageGroup4, Me.ribbonPageGroupOpciones})
        ...
        '
        Me.LSDRegistro04BindingSource.DataSource = GetType(YiZi.AccesoDatos.LSDRegistro04)
        '
        'gridViewReg04
        '
        ...
        '
        Me.CodigosDeRevistasBindingSource.DataSource = GetType(YiZi.AccesoDatos.CodigosDeRevistas)
        '
        ...
        '
        Me.CodigosDeCondicionesBindingSource.DataSource = GetType(YiZi.AccesoDatos.CodigosDeCondiciones)
        '
        'GridView1
        '
        ...
        '
        Me.CodigosDeActivdadEmpleadosBindingSource.DataSource = GetType(YiZi.AccesoDatos.CodigosDeActivdadEmpleados)
        '
        'GridView2
        '
        ...
        '
        Me.CodigosDeModalidadDeContratacionBindingSource.DataSource = GetType(YiZi.AccesoDatos.CodigosDeModalidadDeContratacion)
        '
        ...
        '
        Me.CodigosDeSiniestradosBindingSource.DataSource = GetType(YiZi.AccesoDatos.CodigosDeSiniestrados)
        '
        'GridView3
        '
        ...
        '
        Me.CodigosDeLocalidadesBindingSource.DataSource = GetType(YiZi.AccesoDatos.CodigosDeLocalidades)
        '
        'GridView4
        '
        ...
        '
        Me.LSDRegistro03BindingSource.DataSource = GetType(YiZi.AccesoDatos.LSDRegistro03)
        '
        'gridViewReg03
        '
        ...
        '
        Me.LSDRegistro02BindingSource.DataSource = GetType(YiZi.AccesoDatos.LSDRegistro02)
        '
        'gridViewReg02
        '
        ...
        '
        Me.IdentificacionEnvioBindingSource.DataSource = GetType(YiZi.AccesoDatos.IdentificacionEnvio)
        '
