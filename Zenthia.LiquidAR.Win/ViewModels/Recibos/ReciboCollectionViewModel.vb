...
Public Class ReciboCollectionViewModel
    Inherits CollectionViewModel(Of Zenthia.AccesoDatos.Recibos, Integer, IModeloDbContextUnitOfWork)
    ...
    Public Overridable Property SelectedItems As IEnumerable(Of Zenthia.AccesoDatos.Recibos)
    ...
    Public Sub Imprimir()
        ...
        SelectedItems = New Zenthia.AccesoDatos.Recibos(-1) {} 'Limpio la seleccion de la Grilla
    End Sub
