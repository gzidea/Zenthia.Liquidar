...
<DevExpress.Utils.MVVM.UI.ViewType("UsuarioCollectionView")>
Public Class Usuarios
    ...
    Private Sub InitBindings()
        ...
        Dim fluentAPI = mvvmContext.OfType(Of UsuarioCollectionViewModel)()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.AccesoDatos.Usuarios), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
