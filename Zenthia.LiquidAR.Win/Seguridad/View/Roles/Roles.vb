...
Public Class Roles
    ...
    Private Sub InitBindings()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.AccesoDatos.Roles), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
