...
Public Class UsuarioViewModel
    Inherits SingleObjectViewModel(Of Zenthia.AccesoDatos.Usuarios, Integer, IModeloDbContextUnitOfWork)
    ...
    Public ReadOnly Property LookUpRoles As IEntitiesViewModel(Of Zenthia.AccesoDatos.Roles)
        Get
