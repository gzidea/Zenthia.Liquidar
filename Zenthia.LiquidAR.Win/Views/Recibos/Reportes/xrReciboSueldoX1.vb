...
Public Class xrReciboSueldoX1
    ...
    Private Sub Detail1_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Detail1.BeforePrint
        ...
        '    TryCast(DetailReport.GetCurrentRow, Zenthia.AccesoDatos.RecibosDetalles).Descuento +
        '    TryCast(DetailReport.GetCurrentRow, Zenthia.AccesoDatos.RecibosDetalles).NoRemunerativo
