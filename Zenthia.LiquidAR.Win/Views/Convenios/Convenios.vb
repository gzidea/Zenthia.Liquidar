...
Public Class Convenios
    ...
    Private Sub InitBindings()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.AccesoDatos.Convenios), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
