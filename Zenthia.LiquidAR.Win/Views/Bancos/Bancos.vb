...
<DevExpress.Utils.MVVM.UI.ViewType("BancosCollectionView")>
Public Class Bancos
    ...
    Private Sub InitBindings()
        ...
        Dim fluentAPI = mvvmContext.OfType(Of BancosCollectionViewModel)()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.AccesoDatos.Bancos), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
