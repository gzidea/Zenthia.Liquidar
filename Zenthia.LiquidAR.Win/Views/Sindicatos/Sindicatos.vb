...
<DevExpress.Utils.MVVM.UI.ViewType("SindicatoCollectionView")>
Public Class Sindicatos
    ...
    Private Sub InitBindings()
        ...
        Dim fluentAPI = mvvmContext.OfType(Of SindicatoCollectionViewModel)()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.AccesoDatos.Sindicatos), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
        ...
        'fluentAPI.WithEvent(TryCast(wuibpGeneral.Buttons(7), WindowsUIButton), "Click").EventToCommand(Sub(x) x.Close())
    End Sub
End Class
