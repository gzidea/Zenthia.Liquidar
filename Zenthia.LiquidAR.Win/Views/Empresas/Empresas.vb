...
<DevExpress.Utils.MVVM.UI.ViewType("EmpresasCollectionView")>
Public Class Empresas
    ...
    Private Sub InitBindings()
        ...
        Dim fluentAPI = mvvmContext.OfType(Of EmpresaCollectionViewModel)()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.AccesoDatos.Empresas), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
