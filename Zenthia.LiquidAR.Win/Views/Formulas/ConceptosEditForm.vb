...
Public Class ConceptosEditForm
    Public Sub New()
        ...
        ColumnaReciboLookUpEdit.Properties.AddEnum(Of Zenthia.AccesoDatos.Entidades.enmColumnaRecivo)()
    ...
    Private Sub InitBindings()
        ...
        fluent.SetBinding(GruposCostosBindingSource, Function(abs) abs.DataSource, Function(x) x.LookUpGruposCostos.Entities)
    End Sub
End Class
