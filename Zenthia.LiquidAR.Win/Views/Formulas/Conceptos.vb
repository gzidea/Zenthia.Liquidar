...
<DevExpress.Utils.MVVM.UI.ViewType("ConceptosCollectionView")>
Public Class Conceptos
    ...
    Private Sub InitBindings()
        ...
        Dim fluentAPI = MvvmContext.OfType(Of ConceptosCollectionViewModel)()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.AccesoDatos.Conceptos), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
