...
<DevExpress.Utils.MVVM.UI.ViewType("LSDRegistros01CollectionView")>
Public Class LSDRegistros01
    Public Sub New()
    ...
    Private Sub InitBindings()
        ...
        Dim fluentAPI = mvvmContext.OfType(Of LSDRegistro01CollectionViewModelvb)()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.AccesoDatos.LSDRegistro01), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
