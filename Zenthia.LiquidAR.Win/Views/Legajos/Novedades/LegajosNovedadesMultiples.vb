...
Public Class LegajosNovedadesMultiples
    ...
    Private Sub LegajosNovedadesBindingSource_CurrentItemChanged(sender As Object, e As EventArgs) Handles LegajosNovedadesBindingSource.CurrentItemChanged
        If TryCast(LegajosNovedadesBindingSource.Current, Zenthia.AccesoDatos.LegajosNovedades) Is Nothing Then
            gridControl.DataSource = Nothing
            Return
        End If
        gridControl.DataSource = TryCast(LegajosNovedadesBindingSource.Current, Zenthia.AccesoDatos.LegajosNovedades).LegajosNovedadesDetalles
    End Sub
