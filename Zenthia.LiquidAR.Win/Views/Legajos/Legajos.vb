...
<DevExpress.Utils.MVVM.UI.ViewType("LegajosCollectionView")>
Public Class Legajos
    ...
    Private Sub InitBindings()
        ...
        Dim fluentAPI = mvvmContext.OfType(Of LegajoCollectionViewModel)()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.AccesoDatos.Legajos), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
        ...
        AddHandler gridView.RowClick, Sub(s, e)
                                          ...
                                          End If
                                      End Sub
        DevExpress.Utils.MVVM.MVVMContext.SetParentViewModel(FiltrosEmpresas1, fluentAPI.ViewModel)
    End Sub
