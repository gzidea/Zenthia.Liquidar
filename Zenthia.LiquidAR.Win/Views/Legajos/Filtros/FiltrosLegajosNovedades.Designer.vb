...
Partial Class FiltrosLegajosNovedades
    ...
    Private Sub InitializeComponent()
        ...
        Me.mvvmContextLegajos.ViewModelType = GetType(Zenthia.LiquidAR.Win.LegajoCollectionViewModel)
        '
        'imageCollection
        '
        ...
        Me.mvvmContextTipoLoquidacion.ViewModelType = GetType(Zenthia.LiquidAR.Win.TipoLiquidacionCollectionViewModel)
        '
