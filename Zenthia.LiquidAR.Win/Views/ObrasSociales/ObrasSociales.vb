...
<DevExpress.Utils.MVVM.UI.ViewType("ObrasSocialesCollectionView")>
Public Class ObrasSociales
    ...
    Private Sub InitBindings()
        ...
        Dim fluentAPI = mvvmContext.OfType(Of ObraSocialCollectionViewModel)()
        ...
        fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.AccesoDatos.ObrasSociales), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
