...
<DevExpress.Utils.MVVM.UI.ViewType("ObrasSocialesView")>
Public Class ObraSocialEditForm
    Public Sub New()
    ...
    Private Sub InitBindings()
        ...
        Dim fluent = mvvmContext.OfType(Of ObraSocialViewModel)()
        fluent.WithEvent(Me, "Load").EventToCommand(Sub(x) x.OnLoaded())
        fluent.SetObjectDataSourceBinding(ObrasSocialesBindingSource, Function(x) x.Entity, Sub(x) x.Update())
