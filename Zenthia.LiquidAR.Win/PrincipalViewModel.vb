...
Partial Class PrincipalViewModel
    ...
    Protected Overrides Function CreateModules() As PrincipalModuleDescription()
        Return New PrincipalModuleDescription() {New PrincipalModuleDescription("Sindicatos", "SindicatoCollectionView", _TablesGroup, GetPeekCollectionViewModelFactory(Function(x) x.Sindicatos)),
                                                   ...
                                                   New PrincipalModuleDescription("Libro de Sueldo Digital", "LSDRegistros01CollectionView", _TablesGroup, GetPeekCollectionViewModelFactory(Function(x) x.LSDRegistro01)),
                                                   New PrincipalModuleDescription("Bancos", "BancosCollectionView", _TablesGroup, GetPeekCollectionViewModelFactory(Function(x) x.Bancos)),
                                                   New PrincipalModuleDescription("Conceptos generales", "ConceptosCollectionView", _TablesGroup, GetPeekCollectionViewModelFactory(Function(x) x.Conceptos))}
    End Function
    ...
    Private _empresaactual As Zenthia.AccesoDatos.Empresas
    Public Property EmpresaActual As Zenthia.AccesoDatos.Empresas
        Get
            Return _empresaactual
        End Get
        Set(value As Zenthia.AccesoDatos.Empresas)
