...
#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            '
            Me.accountCollectionViewBindingSource.DataSource = GetType(Zenthia.mvvm.Model.Account)
            '
            'gridView
            '
            ...
            'mvvmContext
            '
            Me.mvvmContext.BindingExpressions.AddRange(New DevExpress.Utils.MVVM.BindingExpression() {DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(Zenthia.mvvm.ViewModels.AccountCollectionViewModel), "New", Me.bbiNew), DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(GetType(Zenthia.mvvm.ViewModels.AccountCollectionViewModel), "Edit", "SelectedEntity", Me.bbiEdit), DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(GetType(Zenthia.mvvm.ViewModels.AccountCollectionViewModel), "Delete", "SelectedEntity", Me.bbiDelete), DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(Zenthia.mvvm.ViewModels.AccountCollectionViewModel), "Refresh", Me.bbiRefresh)})
            ...
            Me.mvvmContext.ViewModelType = GetType(Zenthia.mvvm.ViewModels.AccountCollectionViewModel)
            '
            'popupMenu
            '
