...
Namespace Zenthia.mvvm.Views
    ...
    Partial Public Class Categories
        ...
        Private Sub InitBindings()
            ...
            Dim fluentAPI = mvvmContext.OfType(Of Zenthia.mvvm.ViewModels.CategoryCollectionViewModel)()
            ...
            fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, Zenthia.mvvm.Model.Category), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
