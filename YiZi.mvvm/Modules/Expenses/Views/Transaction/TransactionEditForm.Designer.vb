...
#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            'bindingSource
            '
            Me.bindingSource.DataSource = GetType(YiZi.mvvm.Model.Transaction)
            '
            'accountBindingSource
            '
            Me.accountBindingSource.DataSource = GetType(YiZi.mvvm.Model.Account)
            '
            ...
            '
            Me.categoryBindingSource.DataSource = GetType(YiZi.mvvm.Model.Category)
            '
            'DateDateEdit
            '
            ...
            'mvvmContext
            '
            Me.mvvmContext.BindingExpressions.AddRange(New DevExpress.Utils.MVVM.BindingExpression() {DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(YiZi.mvvm.ViewModels.TransactionViewModel), "Save", Me.bbiSave), DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(YiZi.mvvm.ViewModels.TransactionViewModel), "SaveAndClose", Me.bbiSaveAndClose), DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(YiZi.mvvm.ViewModels.TransactionViewModel), "SaveAndNew", Me.bbiSaveAndNew), DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(YiZi.mvvm.ViewModels.TransactionViewModel), "Reset", Me.bbiReset), DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(YiZi.mvvm.ViewModels.TransactionViewModel), "Delete", Me.bbiDelete), DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(YiZi.mvvm.ViewModels.TransactionViewModel), "Close", Me.bbiClose)})
            Me.mvvmContext.ContainerControl = Me
            Me.mvvmContext.ViewModelType = GetType(YiZi.mvvm.ViewModels.TransactionViewModel)
            '
            'bbiSave
            '
