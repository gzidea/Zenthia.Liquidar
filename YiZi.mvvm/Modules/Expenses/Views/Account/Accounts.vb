...
Namespace YiZi.mvvm.Views
    ...
    Partial Public Class Accounts
        ...
        Private Sub InitBindings()
            ...
            Dim fluentAPI = mvvmContext.OfType(Of YiZi.mvvm.ViewModels.AccountCollectionViewModel)()
            ...
            fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, YiZi.mvvm.Model.Account), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
