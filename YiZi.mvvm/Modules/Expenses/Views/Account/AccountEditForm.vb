...
Namespace YiZi.mvvm.Views
    ...
    Partial Public Class AccountEditForm
        ...
        Private Sub InitBindings()
            ...
            fluent.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(transactionsGridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.AccountTransactionDetails.SelectedEntity, Function(args) TryCast(args.Row, YiZi.mvvm.Model.Transaction), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
