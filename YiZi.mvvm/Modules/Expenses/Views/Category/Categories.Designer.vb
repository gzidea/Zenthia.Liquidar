...
#Region "Component Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            '
            Me.categoryCollectionViewBindingSource.DataSource = GetType(YiZi.mvvm.Model.Category)
            '
            'gridView
            '
            ...
            'mvvmContext
            '
            Me.mvvmContext.BindingExpressions.AddRange(New DevExpress.Utils.MVVM.BindingExpression() {DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(YiZi.mvvm.ViewModels.CategoryCollectionViewModel), "New", Me.bbiNew), DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(GetType(YiZi.mvvm.ViewModels.CategoryCollectionViewModel), "Edit", "SelectedEntity", Me.bbiEdit), DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(GetType(YiZi.mvvm.ViewModels.CategoryCollectionViewModel), "Delete", "SelectedEntity", Me.bbiDelete), DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(YiZi.mvvm.ViewModels.CategoryCollectionViewModel), "Refresh", Me.bbiRefresh)})
            ...
            Me.mvvmContext.ViewModelType = GetType(YiZi.mvvm.ViewModels.CategoryCollectionViewModel)
            '
            'popupMenu
            '
