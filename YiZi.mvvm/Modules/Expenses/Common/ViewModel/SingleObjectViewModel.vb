    ...
    Public MustInherit Class SingleObjectViewModelBase(Of TEntity As Class, TPrimaryKey, TUnitOfWork As IUnitOfWork)
        ...
        Private Sub UpdateTitle(Optional ByVal nullEntityValue As String = Nothing)
            ...
            Else
                ...
                Else
                    _title = GetTitle(GetState() = EntityState.Modificado)
                End If
            End If
            Me.RaisePropertyChanged(Function(x) x.Title)
            Me.RaisePropertyChanged(Function(x) x.Estado)
        End Sub
        ...
        Public Function IsNew() As Boolean
            Return GetState() = EntityState.Agregado
        End Function
        ...
        Protected Overridable Function NeedSave() As Boolean
            ...
            End If
            Dim state As EntityState = GetState()
            Return state = EntityState.Modificado OrElse state = EntityState.Agregado
        End Function
        ...
        Private Sub RestoreState(ByVal state As SingleObjectViewModelState) Implements ISupportLogicalLayout(Of SingleObjectViewModelState).RestoreState
            ...
            LoadEntityByKey(key)
            If Entity Is Nothing Then
                UpdateTitle(state.Title + Demos.Properties.CommonResources.Entity_Deleted)
            End If
        End Sub
